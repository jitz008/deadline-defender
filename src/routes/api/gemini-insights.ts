...
Format strictly as a JSON array of strings. No markdown, no preamble.
Example: ["You complete 80% of morning tasks but only 40% after 6pm — schedule deep work before noon.","..."]`;
